...
class VerifyUser extends Notification
{
	...
	public function toMail($notifiable)
	{
		...
		$mailMessage = (new MailMessage)
					...
					->line('<span style="'.$center.'padding: 10px 5px;">Chào mừng <strong>'. $this->user->getFullname() .'</strong> đến với<br>
					...
					->line(is_null($this->password) ? '' : '<span style="'.$center.'">Mật khẩu của bạn: <strong>' . $this->password . '</strong></span>')
					//->action('Xác Nhận', $url)
